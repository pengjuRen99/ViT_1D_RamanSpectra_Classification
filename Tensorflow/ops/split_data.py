...
if __name__ == '__main__':
    split_dataset = SplitDataset(dataset_dir='../Data_set/Reflective_animalBlood_preprocessing', saved_dataset_dir='Datasets/animal_blood/Reflective_animalBlood_preprocessing', show_progress=True)
